...
function TermsAndCondition({ setPageSidebar }) {
  useEffect(() => {
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Terms and Conditions - BuildCode</title>
      ...
      <div className="build-code-t-c-d-fields">
        <h1>Terms and Conditions</h1>
        <br />
        <h2>Welcome to BuildCode</h2>
        <p>
          These terms of service outline the rules and regulations for the use
          of BuildCode's Website.
        </p>
        <p>
          By accessing this website we assume you accept these terms of service
          in full. Do not continue to use BuildCode's website if you do not
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using BuildCode's website you consent
          to the use of cookies in accordance with BuildCode's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, BuildCode and/or it's licensors own the
          intellectual property rights for all material on BuildCode. All
          intellectual property rights are reserved. You may view and/or print
          pages from buildcode.org for your own personal use subject to
          restrictions set in these terms of service.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from buildcode.org</li>
          <li>Sell, rent or sub-license material from buildcode.org</li>
          <li>Reproduce, duplicate or copy material from buildcode.org</li>
        </ol>
        <p>
          Redistribute content from BuildCode (unless content is specifically
        ...
        <ol>
          ...
          <li>
            ...
            ('Comments') in areas of the website. BuildCode does not screen,
            ...
            BuildCode, its agents or affiliates. Comments reflect the view and
            opinion of the person who posts such view or opinion. To the extent
            permitted by applicable laws BuildCode shall not be responsible or
            liable for the Comments or for any loss cost, liability, damages or
            expenses caused and or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </li>
          <li>
            BuildCode reserves the right to monitor all Comments and to remove
          ...
          <li>
            You hereby grant to <strong>BuildCode</strong> a non-exclusive
        ...
        <p>
          ...
          outweighs the absence of BuildCode. and (d) where the link is in the
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:contact@buildcode.org"
            title="send an email to contact@buildcode.org"
          >
            contact@buildcode.org
          </a>
        ...
        <p>
          No use of BuildCode's logo or other artwork will be allowed for
        ...
        <h2>Credit &amp. Contact Information</h2>
        <p>
          ...
          >
            privacyterms.io terms &amp. conditions generator
          </a>
          . If you have any queries regarding any of our terms, please contact
          us at contact@buildcode.org.
        </p>
      </div>
    </>
  );
