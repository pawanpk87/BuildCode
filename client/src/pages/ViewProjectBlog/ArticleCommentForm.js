...
function AddCommentForm({
  ...
  let commentsData = useContext(AllArticleCommentsContext);
  ...
  const appendChildComment = (firstParentId, parentCommentId, data) => {
    ...
    const appendComment = async () => {
      const allCommentsRef = doc(db, "project-blogs", commentsData.urlName);
      try {
  ...
  const addComment = (parentCommentId, firstParentId, data) => {
    ...
    if (parentCommentId) {
      ...
      const addTopLevelComment = async () => {
        const articleRef = doc(db, "project-blogs", commentsData.urlName);
        let tempAllComments = commentsData.allComments;
  ...
  return (
    <div className="add-article-comment-form">
